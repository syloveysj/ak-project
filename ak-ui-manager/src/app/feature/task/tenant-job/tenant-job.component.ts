...
@Component({
    selector: 'app-task-tenant-job',
    templateUrl: './tenant-job.component.html',
    styleUrls: ['./tenant-job.component.css']
})
export class TenantJobComponent extends BaseComponent implements OnInit {
    scrollXWidth = 0;
